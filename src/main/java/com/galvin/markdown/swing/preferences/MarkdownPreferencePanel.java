...
extends JPanel
{
    ...
    private JLabel pathToPandocLabel = new JLabel( messages.pandocPath() );
    private JTextField pathToPandocField = new JTextField();
    
    private JLabel pathPdfLatexLabel = new JLabel( messages.pdfLatexPath() );
    private JTextField pathToPdfLatexField = new JTextField();
    
    private JLabel pathToKindleGenLabel = new JLabel( messages.kindleGenPath() );
