...
public class GroovyMenu
    ...
    private JMenuItem reloadScriptsItem = createMenuItem( messages.groovyReload(), listener );
    private JMenuItem openScriptsDirItem = createMenuItem( messages.groovyOpenDir(), listener );
    private MenuComparator menuComparator = new MenuComparator();

    public GroovyMenu( Controller controller ) {
        setText( messages.groovy() );
    ...
    private class NoScriptsMenuItem
        ...
        public NoScriptsMenuItem() {
            super( messages.groovyNoScripts() );
            setEnabled( false );
        }
