...
public class ContributorWidget
    ...
    private JLabel nameLabel = new JLabel( messages.labelName() );
    private JTextField nameField = new JTextField();
    private JLabel sortByLabel = new JLabel( messages.labelSortByName() );
    private JTextField sortByField = new JTextField();
    private JLabel roleLabel = new JLabel( messages.labelRole() );
