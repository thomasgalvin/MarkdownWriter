...
public class SeparatorsCompileOptionsPanel extends AbstractCompileOptionsPanel {
    ...
    private JLabel separatorSameLevelLabel = new JLabel( messages.separatorSame() );
    ...
    private JLabel separatorHigherToLowerLabel = new JLabel( messages.separatorHighterToLower() );
    ...
    private JLabel separatorLowerToHigherLabel = new JLabel( messages.separatorLowerToHighter() );
    ...
    private JLabel endOfDocumentMarkerLabel = new JLabel( messages.endOfDocument() );
